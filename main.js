...
class titleSceneClass extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('Planks', './assets/exported-images/cPathTiles.png'); //Load resources for the tilemap JSON (Definetly load before dbnF1.json)
    ...
    create () {
        ...
        let groundFloor = this.make.tilemap({ key: 'map' });

        let terrain = groundFloor.addTilesetImage('ground', 'Planks');
        let layers = groundFloor.createLayer(0, terrain, 0, 0);
    }
}
